      ...
      <motion.div key={location.pathname} className="w-full relative z-10">
        ...
        >
          <motion.div
            ...
            className="flex flex-col items-center justify-center space-y-2 text-center px-6 max-w-full"
          >
            ...
            <span className="text-[11px] sm:text-sm font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-white font-heading">
